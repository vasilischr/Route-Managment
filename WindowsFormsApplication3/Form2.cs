...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        string exfile = Directory.GetCurrentDirectory()+"excel.xlsx";
        string Lawfile = Directory.GetCurrentDirectory() + @"\law.txt";
        ...
        public Form2(string id, String name)
        {
            ...
            else
            {
                ...
                try
                {
                    textBox13.Text = File.ReadAllText(Lawfile);
                    Law();
                }
                catch { }
                timer1.Start();
                ...
                cmd.CommandText = "select Plate from Cars;";
                adap = new MySqlDataAdapter(cmd);
                ...
                foreach (DataRow row in dss.Tables[0].Rows)
                {
                    comboBox7.Items.Add(row["Plate"].ToString());
                }
            ...
            foreach (DataRow row in dss1.Tables[0].Rows)
            {
                ...
                if(ID.Contains("Admin"))
                    comboBox13.Items.Add(row["LastName"].ToString());
            }
                ...
                switch (e.ClickedItem.Name.ToString())
                {
                    case "Delete":
                        if (AcceptEvent(SelectedId) == 1)
                        {
                            ...
                            MessageBox.Show("Arrival Date is not later than"+DateTime.Now.AddDays(1).ToString("dd/MM/yyyy")) ;
                        }
                        break;
                    case "Update":
                        if (AcceptEvent(SelectedId) == 1)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (textBox16.Text.Equals("") && ID.Contains("Admin"))
                {
                    ...
                    try
                    {
                        ...
                        if (!ID.Contains("Admin"))
                        {
                            ...
                            cmd1.Parameters.AddWithValue("@daddress1", comboBox5.Text);
                             value = (int)cmd1.ExecuteScalar();
                        }
                        else {
                            value = Convert.ToDouble((textBox12.Text));
                        }
                        ...
                        {/*YES*/
                            ...
                            MySqlCommand cmd = cnn.CreateCommand();
                            //CREATE COMMAND
                            cmd.CommandText = "insert into Book(DateAdded,FirstName,LastName,NumPeople,Car,phone,Email,DAddress,DAInfo,Remarks,MOArrival,ADate,ATime,ID,Price,Plate,MOinfo,R_Code) "+
                                "Values(@TN,@firstname,@lastname,@numpeople,@car,@phone,@email,@daddress,@Dainfo,@Remarks,@moarrival,@adate,@atime,@id112,@price,@plate,@moainfo,@RCode); select last_insert_id(); ";
                            ...
                            if (!ID.Contains("Admin"))
                            {
                                ...
                                cmd.Parameters.AddWithValue("@daddress", textBox17.Text);
                                cmd.Parameters.AddWithValue("@moarrival", textBox14.Text);
                            }
                            cmd.Parameters.AddWithValue("@moainfo", textBox15.Text);
                            ...
                            cmd.Parameters.AddWithValue("@id112", ID);
                            cmd.Parameters.AddWithValue("@Remarks", richTextBox1.Text);
                            cmd.Parameters.AddWithValue("@price",textBox12.Text);
                            cmd.Parameters.AddWithValue("@plate", comboBox7.Text);
                            cmd.Parameters.AddWithValue("@RCode", textBox16.Text);
                            //EXECUTE AND KEEP ID
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (i > 0 && ii > 0)
            {
                ...
                {
                    table = new iTextSharp.text.pdf.PdfPTable(i - 6);
                    ...
                    else
                    {
                        ...
                        {
                            if (dataGridView1.Columns[k - 1].HeaderText.Equals("Driver") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("Price") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("User") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("R_Code") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("DAddress") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("MOArrival") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("Arrival") ||
                                 dataGridView1.Columns[k - 1].HeaderText.Equals("IDBook"))
                            {
                                
                                table.AddCell(new iTextSharp.text.pdf.PdfPCell(new iTextSharp.text.Phrase(dataGridView1.Columns[k-1].HeaderText, font1)));
                            }
                    ...
                    for (int k = 0; k < i; k++)
                    {
                        ...
                        if (ii > 0)
                        {
                            ...
                            else
                            {
                                    ...
                                    if (dataGridView1.Columns[k].HeaderText.Equals("Driver") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("Price") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("User") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("R_Code") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("DAddress") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("MOArrival") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("Arrival") ||
                                         dataGridView1.Columns[k].HeaderText.Equals("IDBook"))
                                    {
                                        table.AddCell(new iTextSharp.text.pdf.PdfPCell(new iTextSharp.text.Phrase(row.Cells[dataGridView1.Columns[k].HeaderText].Value.ToString(), font1)));
                                    }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "update Book set FirstName = @firstname  , LastName=@lastname , NumPeople=@numpeople , Car=@car ,Plate=@plate, phone=@phone , Email=@email , DAddress=@daddress , DAInfo=@dainfo,Remarks=@Remarks , MOArrival=@moarrival , ADate=@adate , ATime=@atime,R_Code=@code,MOinfo=@moinfo   where IDBook=@id3;";
                    ...
                    cmd.Parameters.AddWithValue("@phone", textBox4.Text.ToString());
                    cmd.Parameters.AddWithValue("@email", textBox5.Text.ToString());
                    cmd.Parameters.AddWithValue("@daddress", textBox17.Text.ToString());
                      cmd.Parameters.AddWithValue("@plate", comboBox7.Text.ToString());
                    //cmd.Parameters.AddWithValue("@Dainfo2", textBox12.Text.ToString());
                    cmd.Parameters.AddWithValue("@Dainfo", textBox6.Text.ToString());
                    cmd.Parameters.AddWithValue("@Remarks", richTextBox1.Text.ToString());
                    cmd.Parameters.AddWithValue("@moarrival", textBox14.Text.ToString());
                    cmd.Parameters.AddWithValue("@moinfo", textBox15.Text.ToString());
                    cmd.Parameters.AddWithValue("@adate", dateTimePicker1.Value.ToString("yyyy/MM/dd"));
                    cmd.Parameters.AddWithValue("@atime", comboBox2.Text.ToString());
                    cmd.Parameters.AddWithValue("@code", textBox16.Text.ToString());
                    cmd.Parameters.AddWithValue("@price", textBox12.Text.ToString());
                    cmd.Parameters.AddWithValue("@id3", SelectedId);
                    cmd.ExecuteNonQuery();
                }
                Refresh1();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                if (File.Exists(pathDesktop + @"\esol_Data.xlsx"))
                {
                    File.Delete(pathDesktop + @"\esol_Data.xlsx");
                }
                newFile = new FileInfo(pathDesktop + @"\esol_Data.xlsx");
            }
            else
            {
                if (File.Exists(pathDesktop + @"\" + comboBox4.Text.Replace("_Admin", "") + "_data.xlsx"))
                {
                    File.Delete(pathDesktop + @"\" + comboBox4.Text.Replace("_Admin", "") + "_data.xlsx");
                }
                newFile = new FileInfo(pathDesktop + @"\" + comboBox4.Text.Replace("_Admin", "") + "_data.xlsx");
            }
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ExcelWorksheet worksheet = xlPackage.Workbook.Worksheets.Add("Esol");

                int c = 1;
                for (int i = 1; i < dataGridView1.Columns.Count + 1; i++)
                {
                    if (dataGridView1.Columns[i - 1].HeaderText.Equals("Driver") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("Price") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("User") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("R_Code") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("DAddress") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("MOArrival") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("Arrival") ||
                         dataGridView1.Columns[i - 1].HeaderText.Equals("IDBook"))
                    {
                        worksheet.Cells[1, c].Value = dataGridView1.Columns[i - 1].HeaderText;
                        c++;
                    }
                }
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    {
                        if (dataGridView1.Columns[j].HeaderText.Equals("Driver") ||
                            dataGridView1.Columns[j].HeaderText.Equals("Price") ||
                            dataGridView1.Columns[j].HeaderText.Equals("User") ||
                            dataGridView1.Columns[j].HeaderText.Equals("R_Code") ||
                            dataGridView1.Columns[j].HeaderText.Equals("DAddress") ||
                            dataGridView1.Columns[j].HeaderText.Equals("MOArrival") ||
                            dataGridView1.Columns[j].HeaderText.Equals("Arrival") ||
                            dataGridView1.Columns[j].HeaderText.Equals("IDBook"))
                        {
                            if (dataGridView1.Rows[i].Cells[j].Value != null)
                            {

                                worksheet.Cells[i + 2, c].Value = dataGridView1.Rows[i].Cells[j].Value.ToString();
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!(comboBox4.SelectedIndex == 0))
                {
                    ...
                    selects = string.Format("SELECT  IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID  where ADate >='{0}' and ADate <= '{1}'  and Book.ID='{2}' order by ID ", (dateTimePicker6.Value.Date.ToString("yyyy/MM/dd")), (dateTimePicker5.Value.Date.ToString("yyyy/MM/dd")), comboBox4.Text);
                ...
                else
                {
                    ...
                    {
                        selects = string.Format("SELECT  IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID  where ADate >='{0}' and ADate <= '{1}'  and Drivers.LastName='{2}' order by IDBook ", (dateTimePicker6.Value.Date.ToString("yyyy/MM/dd")), (dateTimePicker5.Value.Date.ToString("yyyy/MM/dd")), comboBox13.Text);

                    }
                    else
                    {
                        selects = string.Format("SELECT  IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID  where ADate >='{0}' and ADate <= '{1}'  ", (dateTimePicker6.Value.Date.ToString("yyyy/MM/dd")), (dateTimePicker5.Value.Date.ToString("yyyy/MM/dd")));
                    }
                }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            try
            {
                File.WriteAllText(Lawfile, textBox13.Text);
            }
            catch { MessageBox.Show("Law Write Error"); }
            Law();
        }
        ...
        {
            Color k = Color.FromKnownColor(KnownColor.Control);
            if (DateTime.Compare(dateTimePicker1.Value, DateTime.Now.AddDays(2)) == -1 && !ID.Contains("Admin"))
            {
        ...
        private void EmptyBoxes()
        {
            ...
            if (ID.Contains("Admin")) {
                textBox12.Text = "0";
                textBox14.Text = "EL.Venizelos";
                textBox15.Text = "";
                textBox16.Text = "";
                textBox16.BackColor = Color.White;
                textBox17.Text = "EL.Venizelos";
                comboBox7.SelectedIndex = 0;
            }
            richTextBox1.Text = "";
            dateTimePicker1.Value = DateTime.Today.AddDays(3);
        ...
        private Boolean CheckingValues()
        {
            Color k = Color.FromKnownColor(KnownColor.Control);
            Boolean t = true;
            if ((comboBox3.SelectedIndex == 0 && (!ID.Contains("Admin"))))
            {
            ...
            if ((comboBox5.SelectedIndex == 0) && (!ID.Contains("Admin")))
            {
            ...
            if (comboBox2.Text == "12:01" && (!ID.Contains("Admin")))
            {
        ...
        private Boolean UpdateSetValues()
        {
            try
            {
                ...
                if (!ID.Contains("Admin")){
                    ...
                    cmd.CommandText = string.Format("select DAddress,R_Code,Plate,Remarks,Price,ADate,ATime,MOArrival,MOinfo,FirstName,LastName,NumPeople,Car,phone,Email,DAInfo from Book where  IDBook='{0}' ; ", SelectedId);
                    ...
                    foreach (DataRow row in sa.Rows)
                    {
                        ...
                        comboBox1.Text = row["NumPeople"].ToString();
                        comboBox6.Text = row["Car"].ToString();
                        comboBox7.Text = row["Plate"].ToString();
                        textBox4.Text = row["phone"].ToString();
                        textBox5.Text = row["Email"].ToString();
                        textBox6.Text = row["DAInfo"].ToString();
                        textBox17.Text = row["DAddress"].ToString();
                        textBox12.Text = row["Price"].ToString();
                        textBox16.Text = row["R_Code"].ToString();
                        textBox14.Text = row["MOArrival"].ToString();
                        textBox15.Text = row["MOinfo"].ToString();
                        comboBox2.Text = row["ATime"].ToString();
                        richTextBox1.Text = row["Remarks"].ToString();
        ...
        private void SearchBoxes() {
            try
            {
                ...
                else if (!textBox8.Text.Equals(""))
                {
                    ...
                    if (ID.Contains("Admin"))
                    {
                        selects123 = string.Format("SELECT IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID  where IDBook={0} ;", (textBox8.Text.ToString()));

                    }
                    else
                    {
                        selects123 = string.Format("SELECT  IDBook, Book.FirstName, Book.LastName, NumPeople, Car, phone, Email, DAddress, DAInfo,Remarks, MOArrival, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added, Book.ID FROM Book where IDBook={0} and ID='{1}' ;", textBox8.Text.ToString(), ID);
                       
                    }
                    try
                    {
                        cmd.CommandText = selects123;
                        MySqlDataAdapter adap2 = new MySqlDataAdapter(cmd);
                        DataSet dddas = new DataSet();
                        adap2.Fill(dddas);
                        dataGridView1.DataSource = dddas.Tables[0].DefaultView;
                        FixCollumn();
                        textBox8.Text = "";
                    }
                    catch {  }
                ...
                else if (!textBox10.Text.Equals("") /*&& chs*/)
                {
                    ...
                    if (ID.Contains("Admin"))
                    {
                        ...
                        selcts = string.Format("SELECT  IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID where Book.LastName LIKE CONCAT('{0}', '%') ;", textBox10.Text);
                    }
                    else
                    {
                ...
                else if (!(dateTimePicker2.Value.Date == DateTime.Now.AddDays(1).Date && dateTimePicker3.Value.Date == DateTime.Now.AddDays(1).Date))
                {
                    ...
                    if (ID.Contains("Admin"))
                    {
                        selects = string.Format("SELECT  IDBook, FirstName, LastName, NumPeople, Car, phone, Email, DAddress, DAInfo,Remarks, MOArrival, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added, ID from Book where DateAdded >='{0}' and DateAdded <= '{1}' ;", (dateTimePicker2.Value.Date.ToString("yyyy/MM/dd")), (dateTimePicker3.Value.Date.ToString("yyyy/MM/dd")));
                    }
                    else
                    {
                        selects = string.Format("SELECT  IDBook, FirstName, LastName, NumPeople, Car, phone, Email, DAddress, DAInfo,Remarks, MOArrival, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added, ID from Book where DateAdded  >='{0}' and DateAdded <= '{1}' and ID='{2}' ;", (dateTimePicker2.Value.Date.ToString("yyyy/MM/dd")), (dateTimePicker3.Value.Date.ToString("yyyy/MM/dd")), ID);
                    }
                    try
                    {
                        // MessageBox.Show();
        ...
        {
            dr = tmp.NewRow();
            dr["User"] = idss.Replace("_Admin","") + param;
            dr["Car"] = "TAXI";
        ...
        private void Refresh1()
        {
            try
            {
                ...
                if (ID.Contains("Admin"))
                {
                    cmd.CommandText = "SELECT  IDBook, Book.LastName, NumPeople, Car,Plate, DAddress, DAInfo,Remarks, MOArrival,MOinfo, DATE_FORMAT(ADate,'%d/%m/%Y') as Arrival, ATime,DATE_FORMAT(DateAdded,'%d/%m/%Y') as Added,SUBSTR(Book.ID,1,LENGTH(Book.ID) - 6) as User ,Drivers.LastName as Driver,R_Code,Price, phone, Email FROM Book left join Drivers on Book.Driver=Drivers.ID ;";
        ...
        private Boolean CheckingValuesReturn()
        {
            ...
            if (comboBox10.Text == "12:01"&& !ID.Contains("Admin"))
            {
        ...
        private void PrintVoucherOnline(int lid) {
            ...
            {
                MySqlCommand cmd = cnn.CreateCommand();
                string c = String.Format("Select Book.FirstName as FN,Book.LastName as LN,Remarks,MOinfo,Car,NumPeople,ATime,ADate,Drivers.LastName as DLN,Drivers.FirstName as DFN,phone,DAddress,MOArrival from Book left join Drivers on Book.Driver=Drivers.ID where IDBook={0}", lid);
                cmd.CommandText = c;
                MySqlDataAdapter adap = new MySqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                adap.Fill(dt);
                if (dt.Rows.Count > 0)
                {
                    ...
                    using (ExcelPackage xlPackage = new ExcelPackage(newFile))
                    {
                        ...
                        oSheet.Cells[26, 1].Value = dt.Rows[0]["Remarks"].ToString();
                        //Car
                        
                        oSheet.Cells[10, 2].Value = dt.Rows[0]["MOinfo"].ToString();
                        //ID
                        oSheet.Cells[1, 8].Value = lid;


                        // TODO
                        /* ADD Client on voucher */


                        // MessageBox.Show(dt.Rows[0]["DLN"].ToString());
                        if (ID.Contains("Admin"))
                        {
                            oSheet.Cells[40, 3].Value = ID.Replace("_Admin","");
                            oSheet.Cells[44, 3].Value = ID.Replace("_Admin", "");
                            oSheet.Cells[33, 1].Value = textBox13.Text;
                            oSheet.Cells[34, 1].Value = "";
                            if (!dt.Rows[0]["DLN"].ToString().Equals(""))
                            {
                                //    MessageBox.Show(dt.Rows[0]["DLN"].ToString());
                            ...
                            oSheet.Cells[40, 3].Value = ID;
                            oSheet.Cells[44, 3].Value = ID;
                            oSheet.Cells[33, 1].Value = "Vehicle:            " + dt.Rows[0]["Car"].ToString();
                            oSheet.Cells[34, 1].Value = "Number of people:   "+dt.Rows[0]["NumPeople"].ToString();
                            oSheet.Cells[3, 5].Value = "";
                        }
        ...
        private void Law()
        {
            try
            {
                string text = System.IO.File.ReadAllText(Lawfile);
                if (textBox13.Text.Equals(text))
                {
            ...
            catch { MessageBox.Show("Law Check Error \n"+Lawfile); }
        }
